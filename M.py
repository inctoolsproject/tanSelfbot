...
cl = LINE("tanknug1983@gmail.com","https://line.me/R/ti/p/~ptatan1983")
...
#=====================================================================
                            ...
                            if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                for she in target:
                                    ...
                                    sendMention(to, contact.mid, "=͟͟͞͞➳ คุณกำลังก็อปปี้", "สำเร็จแล้ว >_<");cl.sendContact(to, str(BackupProfile.mid));cl.sendContact(to, str(contact.mid))
                            ...
                            try:
                                ...
                                cl.updateProfile(clstatus)
                                clName.displayName = ProfileMe["NameMe"]
                                cl.updateProfile(clName)
                                path = cl.downloadFileURL(ProfileMe["PictureMe"])
                ...
                if text.lower() == "/speed" or text.lower() == "/sp" or text.lower() == "/สปีด":
                    start = time.time()
                    cl.sendMessage("u21d04f683a70ee8776c4c58a0358c204","speed...")
                ...
                if text.lower() == "sp" or text.lower() == "speed":
                    start = time.time()
                    cl.sendMessage("u21d04f683a70ee8776c4c58a0358c204","test speed...")
                    elapsed_time = time.time() - start
                    took = time.time() - start
...
#==============================================================================#
                        ...
                        group = cl.getGroup(to);nama = [contact.mid for contact in group.members];nama.remove(maxgie.getProfile().mid)
                  ...
                  if msg.toType == 2:
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        for ls in lists:
                            ...
                            if len(msg.text.split(' ')) >= 3:h = [cl.unsendMessage(maxgie.sendMessage(to,maxgie.adityasplittext(msg.text,'s')).id) for b in a]
                            ...
                            if "image" in msg_dict[msg_id]:
                                ...
                                if "video" in msg_dict[msg_id]:
                                    ...
                                    if "audio" in msg_dict[msg_id]:
                                        ...
                                        rat_ += "\nAudio :\nBelow"
                                        sendMentionFooter(at, ikkeh.mid, "# Resend Message\n\nMaker :\n", str(rat_))
                                        cl.sendAudio(at, msg_dict[msg_id]["audio"])
                                        del msg_dict[msg_id]
                                    else:
...
def run():
    while True:
        try:
            ...
            if ops != None:
                for op in ops:
                   loop.run_until_complete(clBot(op))
